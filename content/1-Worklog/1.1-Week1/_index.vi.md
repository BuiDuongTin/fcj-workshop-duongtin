...
### Mục tiêu tuần 1:
* Làm quen với chương trình First Cloud Journey và cách ghi worklog.
* Hiểu tổng quan về AWS, cloud computing và phạm vi học tập của module 1.
* Biết cách sử dụng AWS Free Tier, AWS Budget, AWS Support và AWS CLI ở mức cơ bản.
...
* Xem bài giảng mở đầu của module 1.
* Tìm hiểu các giới hạn chi phí khi dùng Free Tier.
* Làm quen với Budget, Support và CLI.
* Ghi chú lại các thành phần cơ bản của AWS để chuẩn bị cho các tuần sau.
